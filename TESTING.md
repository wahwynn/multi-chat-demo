...
- `components/__tests__/MessageInput.test.tsx`: Tests for MessageInput component
- `components/__tests__/ChatWindow.test.tsx`: Tests for ChatWindow component
- `lib/__tests__/api.test.ts`: Tests for API client functions
